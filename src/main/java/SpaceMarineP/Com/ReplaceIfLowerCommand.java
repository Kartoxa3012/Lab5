...
/**
 * Команда {@code replace_if_lowe} – заменяет значение элемента по ключу,
 * если новое значение меньше старого согласно естественному порядку {@link SpaceMarine#compareTo(SpaceMarine)}.
 * <p>
 ...
 * Если новое значение оказывается меньше старого, элемент заменяется; иначе выводится сообщение
...
public class ReplaceIfLowerCommand implements Command {
     ...
     */
    public ReplaceIfLowerCommand(CollectionManager manager, InputManager inputManager) {
        this.manager = manager;
        this.inputManager = inputManager;
    }

    /**
     * Возвращает имя команды – {@code "replace_if_lowe"}.
     *
     ...
     *
     * @return описание: "заменить значение по ключу, если новое значение меньше старого."
     */
    @Override
    ...
    /**
     * Выполняет замену элемента при условии, что новое значение меньше старого.
     * <p>
     ...
     *     <li>Если новое значение меньше, заменяет элемент в коллекции и выводит подтверждение;
